    ...
    <div className="loginGrandParentContaniner">
      <div className="loginParentContainer">
        <Form>
          ...
          <Input name="username" type="text" id="inputUserName" className="mb-3 " placeholder="Gebruikersnaam" autoFocus />
          <Label for="inputPassword" className="float-left">
            <b>Wachtwoord</b>
          </Label>
          <Input name="password" type="password" id="inputPassword" className="mb-4" placeholder="Wachtwoord"/>
